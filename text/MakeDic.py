...
def Wkati(text):
    ...
    keyword = []
    while words:
        if words.feature.split(',')[0]==u'名詞' or words.feature.split(',')[0]==u'動詞'or words.feature.split(',')[0]==u'形容詞' or words.feature.split(',')[0]==u'助詞' or words.feature.split(',')[0]==u'記号': 
